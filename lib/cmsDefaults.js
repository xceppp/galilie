...
const content = {
  ...
  'hero.metric.2_label': 'Professionnels formés',
  ...
  'hero.card.rating': '4,9/5 — 27 avis Google',
  ...
  // Contact
  'contact.scarcity': "Places limitées — Semaine gratuite Licences d'Excellence",
  'contact.title_html': 'Inscrivez-vous à la <em>semaine gratuite</em>',
  'contact.lead':
    'Remplissez le formulaire pour recevoir le lien de connexion. Début des cours : jeudi 23 juillet 2026.',
  'contact.benefits':
    "100% gratuit · À distance · 21h–22h\n7 séances · Comptabilité, économie, management, anglais\nAccompagnement personnalisé\nLien de connexion envoyé après inscription",
  'contact.slots_html': 'Réponse sous <b style="color:var(--gold-lt)">24 h</b> · Places limitées',
...
const announcements = [
  {
    ...
    text: "Parcours intensif gratuit pour préparer vos concours : méthodes, exercices et confiance — à distance.",
    status: 'Inscription ouverte',
    date_day: '23',
    date_month: 'Juil',
    image: 'assets/annonce-semaine-gratuite.png',
    body:
      "Un parcours pédagogique intensif pour consolider vos bases, maîtriser les méthodes d'examen et aborder le concours avec méthode — entièrement gratuit. Début des cours jeudi 23 juillet 2026.",
    details: [
      'Durée :: 1 semaine',
      'Horaire :: 21h00 – 22h00',
      'Format :: À distance',
      "Tarif :: 100% gratuit",
      'Thèmes :: Comptabilité · Analyse financière · Économie · Management · Anglais',
    ].join('\n'),
  ...
  },
  {
    ...
    title: "Nouveaux créneaux d'échange ouverts à Meknès",
    text: 'Premier échange de 20 min — confidentiel, sans engagement. Réponse personnalisée sous 24 heures.',
