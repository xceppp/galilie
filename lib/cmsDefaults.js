...
const content = {
  ...
  // Concours — préparation Bac (examen national)
  'concours.label': 'Préparation Bac',
  'concours.title_html': 'Préparation à l’<em>examen national</em>',
  'concours.subtitle_html':
    'Cours de soutien · Méthode · Exercices · Examens nationaux — présentiel à Meknès ou à distance (tout le Maroc).',
...
const formations = [
  {
    ...
    subtitle: 'Préparation à l’examen national — Pack National ou À la carte.',
    items: [
      ...
      'Mathématiques',
      'Présentiel Meknès · À distance — tout le Maroc',
    ].join('\n'),
    cta_label: 'S’inscrire — 2è BAC SEG →',
  ...
  {
    id: 'f2',
    tag: 'Mathématiques A & B',
    title: 'Sciences Mathématiques A & B',
    subtitle: 'Deux parcours, un même objectif : votre réussite !',
    items: [
    ...
    cta_label: 'S’inscrire — Mathématiques A & B →',
  ...
  {
    id: 'f3',
    tag: 'Sciences Expérimentales',
    title: 'Sciences Expérimentales',
    subtitle: 'Un accompagnement complet pour un excellent résultat !',
    items: [
      'Mathématiques — Consolider les bases et maîtriser les techniques',
      ...
      'Philosophie — Analyser, argumenter, réussir la dissertation',
    ].join('\n'),
    cta_label: 'S’inscrire — Sciences Expérimentales →',
