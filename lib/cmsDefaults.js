...
const content = {
  ...
  'proof.1_value': '1-à-1',
  'proof.1_label': 'accompagnement dédié',
  'proof.2_value': 'Suivi',
...
const nouveau = [
  {
    id: 'nv-master-finance-demo',
    type: 'master',
    title: 'Master Finance & Contrôle de gestion — rentrée 2026',
    summary:
      'Profils bac+3 gestion / éco : dossier + oral. NC vous aide à cadrer le projet professionnel et l’oral.',
    status: 'Inscriptions ouvertes',
    etab: 'FSJES (exemple)',
    deadline: '15 sept. 2026',
    ville: 'Meknès',
    facts: [
      'Établissement :: FSJES (exemple)',
      'Deadline dossier :: 15 septembre 2026',
      'Sélection :: Dossier + oral',
      'Public :: Bac+3 gestion / éco',
    ].join('\n'),
    body:
      'Vérifiez les prérequis et les pièces du dossier avant la deadline. Préparez un projet professionnel clair — souvent décisif à l’oral. Anticipez l’anglais et les bases finance / contrôle.',
    nc_angle:
      'On reformule les faits utiles, on les met dans un ordre actionnable, et on vous accompagne sur le dossier / l’oral si vous voulez passer à l’action.',
    source_label: 'almaster-maroc.com',
    source_url: 'https://www.almaster-maroc.com/',
    active: true,
    order: 1,
  },
  {
    id: 'nv-lex-management-demo',
    type: 'lex',
    title: 'Licence d’Excellence Management — session d’automne',
    summary:
      'Concours sélectif (écrit / oral). On clarifie le calendrier, les matières et un plan de révision réaliste.',
    status: 'Concours à venir',
    etab: 'FSJES (exemple)',
    ...
    body:
      'Notez le format exact du concours (écrit / oral), les packs de spécialité et la date. Construisez un plan de révision par matières pivots.',
    nc_angle:
      'NC Consulting prépare l’oral et les bases (compta, éco, management, anglais) — avec un accompagnement structuré, Meknès ou à distance.',
    source_label: 'licence-professionnelle-maroc.com',
    source_url:
      'https://www.licence-professionnelle-maroc.com/search/label/Licence%20d%27Excellence',
    active: true,
    order: 2,
  },
  {
    id: 'nv-lpro-marketing-demo',
    type: 'lpro',
    title: 'Licence Professionnelle — Marketing digital',
    summary:
      'Ouverture de dossier pour candidats en reprise d’études. Vérifiez les prérequis et le format (temps plein / aménagé).',
    status: 'Places limitées',
    etab: 'EST / IUT (exemple)',
    deadline: '30 août 2026',
    ville: 'Fès-Meknès',
    facts: [
      'Établissement :: EST / IUT (exemple)',
      'Deadline :: 30 août 2026',
      'Format :: Aménagé possible',
      'Public :: Reprise d’études',
    ].join('\n'),
    body:
      'Contrôlez les prérequis, le rythme (plein / aménagé) et les pièces. Si vous travaillez, anticipez le planning dès maintenant.',
    nc_angle:
      'Besoin d’arbitrer Licence Pro vs Excellence vs temps aménagé ? Un échange de 20 min clarifie le bon choix pour votre profil.',
    source_label: 'licence-professionnelle-maroc.com',
    source_url: 'https://www.licence-professionnelle-maroc.com/',
    active: true,
    order: 3,
  },
];
