...
const content = {
  ...
  'hero.title_html':
    'Vous dirigez. Vous décidez seul(e).<br><em>Un regard extérieur exigeant</em> peut changer la trajectoire.',
  'hero.lead':
    'Coaching exécutif et conseil stratégique pour dirigeants et cadres au Maroc — décisions plus rapides, équipes plus alignées, résultats mesurés à 90 jours.',
  'hero.cta_primary': 'Réserver mon appel découverte (20 min, gratuit) →',
  'hero.cta_secondary': 'Comment ça marche',
  'hero.assure': 'Déjà 1 500+ dirigeants et cadres accompagnés au Maroc',
  ...
  'hero.metric.2_label': 'Dirigeants & cadres accompagnés',
  ...
  'about.title_html': 'Découvrez NC Consulting <em>à votre façon</em>.',
  'about.quiz_lead':
    'Choisissez ce qui vous correspond — nous vous guidons vers la présentation complète du cabinet.',
  ...
  'reels.subtitle_html':
    'Paroles d\'experts, témoignages vidéo et actualités — la preuve de notre engagement terrain.',
  'reels.note_html':
    'Suivez nos actualités sur <a href="https://www.linkedin.com/company/nc-consulting10" target="_blank" rel="noopener noreferrer">LinkedIn</a> et nos témoignages vidéo sur <a href="https://www.instagram.com/ncconsultingg/" target="_blank" rel="noopener noreferrer">Instagram</a>.',
